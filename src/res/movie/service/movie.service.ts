...
export class MovieService {
    ...
    async createMovie(movieRequestDto: MovieRequestDto): Promise<MovieResponseDto> {
    ...
    async updateMovie(id: number, movieRequestDto: MovieRequestDto): Promise<MovieResponseDto> {
